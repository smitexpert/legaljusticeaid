                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" class="form-control">@if(old('description')){{ old('description') }}@else{{ $service->description }}@endif</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                                ...
                                                <div class="input-tags">
                                                    @if (old('tags'))
                                                        @foreach (old('tags') as $tag)
                                                            <div class="tag">{{ $tag }} <i onclick="removeTags(event)" class="fa fa-close"></i><input type="hidden" name="tags[]" value="{{ $tag }}"></div>
                                                        @endforeach
                                                    @else

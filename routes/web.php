...
Route::middleware('preventBackButton')->group(function(){
  ...
  Route::group(['middleware' => 'managerRoute'], function () {
    Route::prefix('/admin/blog')->namespace('Blog')->group(function(){
      Route::get('/slider', 'BlogHomeController@slider');
      Route::get('/slider/add/{id}', 'BlogHomeController@sliderAdd');
      Route::get('/slider/remove/{id}', 'BlogHomeController@sliderRemove');
      Route::get('/list', 'BlogHomeController@list');
      Route::get('/category', 'HomeCategoryController@index');
      Route::post('/category', 'HomeCategoryController@setcategory')->name('admin.home.category');
    });
